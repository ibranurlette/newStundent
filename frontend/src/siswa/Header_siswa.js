...
class Header_siswa extends Component{
  componentDidMount(){
    this.props.getUsers();
  }
  render(){
  ...
  return (
    ...
    <Navbar bg="light" expand="lg" className="fixed-top" id="navbar_landing">
      ...
      <Dropdown.Menu>
       <Link to="/payment">
        <p className="ml-4"><GiPayMoney className="mr-3"/>payment</p>
      </Link>
      <Link to="/">
...
export default connect(mapStateToProps, mapDispatchToProps)(Header_siswa);
// export default Header_siswa;
